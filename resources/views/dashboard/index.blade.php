...
{{-- ── ROW 2: TRANSAKSI TERBARU + KATEGORI ── --}}
<div style="display:grid;grid-template-columns:1.2fr 0.8fr;gap:12px;margin-bottom:12px;">
    ...
    <div class="card">
        ...
        <div style="padding:0 18px;">
            <div style="display:grid;grid-template-columns:1fr auto auto;gap:8px;padding:8px 0;font-size:11px;color:var(--text-muted);border-bottom:1px solid #F0F0EC;font-weight:600;letter-spacing:0.03em;text-transform:uppercase;">
